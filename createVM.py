...
if __name__=='__main__':
	...
	parser.add_argument('param4', type=str, help='El path de la imagen')
	parser.add_argument('param5', type=str, help='Size Ram de la VM')
	parser.add_argument('param6', type=str, help='Dirección MAC')
